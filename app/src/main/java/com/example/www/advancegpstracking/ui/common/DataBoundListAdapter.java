...
public abstract class DataBoundListAdapter<T, V extends ViewDataBinding>
    ...
    public final DataBoundViewHolder<V> onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        System.out.println("onCreateViewHolder in ui/common DataBoundListAdapter anurag");
    ...
    public final void onBindViewHolder(DataBoundViewHolder<V> holder, int position) {
        ...
        System.out.println("onBindViewHolder in ui/common DataBoundListAdapter anurag");
    ...
    public void replace(List<T> update) {
        ...
        System.out.println("replace in ui/common DataBoundListAdapter anurag");
        dataVersion ++;
        if (items == null) {
            if (update == null) {
                return;
