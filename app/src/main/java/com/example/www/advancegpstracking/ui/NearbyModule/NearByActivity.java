package com.example.www.advancegpstracking.ui.NearbyModule;
...
GoogleApiClient.OnConnectionFailedListener,
    ...
    private Marker currentLocationmMarker,near;
    ...
    private void hideSoftKeyboard() {this.getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);
    }
    @Override
    ...
    private String getUrl(double latitude , double longitude , String nearbyPlace)
    {
        ...
        googlePlaceUrl.append("&key="+"AIzaSyBLtHX5AelnENrkAzJF1x9Xr03yoXFa9h8");

        Log.d("NearByActivity", "url = "+googlePlaceUrl.toString());
