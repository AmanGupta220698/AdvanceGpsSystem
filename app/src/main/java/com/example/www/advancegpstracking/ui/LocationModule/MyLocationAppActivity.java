package com.example.www.advancegpstracking.ui.LocationModule;
...
public class MyLocationAppActivity extends AppCompatActivity {
 ...
 */
    ...
    protected void onStart(Intent i, int startId) {
    ...
    public Runnable GpsFinder = new Runnable() {
        ...
        public void run() {
            ...
            if (locMan.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
                ...
                if (ActivityCompat.checkSelfPermission(MyLocationAppActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(MyLocationAppActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                    // TODO: Consider calling
                    //    ActivityCompat#requestPermissions
                    // here to request the missing permissions, and then overriding
                    //   public void onRequestPermissionsResult(int requestCode, String[] permissions,
